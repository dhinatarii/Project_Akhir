            ...
            <table style="width: 100%; height: 100%; background:rgba(249.67, 249.67, 249.67, 0.65); box-shadow: 0px 15px 40px rgba(68, 93, 72, 0.10); border-top-left-radius: 20px; border-top-right-radius: 20px">
                ...
                <tbody style="background: #FAFAFA;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo $customer -> ID_PEBISNIS; ?></td>
                        <td><?php echo $total_kategori[$customer->ID_PEBISNIS]; ?> kategori</td>
                        <td><?php echo $total_produk[$customer->ID_PEBISNIS]; ?> produk</td>
                        <td><?php echo $total_penyewa[$customer->ID_PEBISNIS]; ?> penyewa</td>
                        <td><?php echo $total_transaksi[$customer->ID_PEBISNIS]; ?> transaksi</td>
                    </tr>
                    <?php $no++;  } ?>
                </tbody>
            </table>
